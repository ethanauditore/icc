...
public class Estudiante {
    ...
    /**
     * Nos dice si el estudiante recibido es igual al que manda llamar el método.
     *
    ...
    public boolean equals(Estudiante estudiante) {
        if (estudiante == null)
            return false;
        return nombre.equals(estudiante.nombre) && cuenta == estudiante.cuenta
            && promedio == estudiante.promedio && edad == estudiante.edad;
    }
}
